...
import { DELETE_TASK, ADD_TASK } from "../utils/mutations";
...
export default function ProjectCardBody({ project }) {
  ...
  const handleDeleteTask = async (index) => {
    try {
      await deleteTask({
        variables: { projectId: project._id, taskIndex: index },
      });
  ...
  return (
    <>
            ...
            <div>
              <h1>
                <div className="text-sm leading-6 text-gray-500">
                  Project ID
                  <span className="text-gray-700">#{project.projectCode}</span>
                </div>
      ...
      <div className="px-4 py-10 ">
        <div className=" grid  grid-cols-1 grid-rows-1 items-start gap-x-8 gap-y-8 lg:mx-0 lg:max-w-none lg:grid-cols-3">
          {/* Project summary */}
          <div>
            <ChartCard />
          </div>
          ...
          <div className="-mx-4 px-4 py-8 shadow-sm ring-1 ring-gray-900/5 sm:mx-0 sm:rounded-lg sm:px-8 sm:pb-14 lg:col-span-2 lg:row-span-2 lg:row-end-2 xl:px-16 xl:pb-20 xl:pt-16">
            ...
            <dl className="mt-6 grid grid-cols-1 text-sm leading-6 sm:grid-cols-2">
              <div className="sm:pr-4">
                <dt className="inline text-gray-500">{project.description}</dt>
                <dd className="inline text-gray-700"></dd>
              </div>

              <div className="mt-2 sm:mt-0 sm:pl-4">
                <dt className="inline text-gray-900 font-semibold">Status :</dt>
